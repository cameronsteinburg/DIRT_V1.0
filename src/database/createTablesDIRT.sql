...
insert into Clients (name, phone1, phone2, description, email, address, isActive) values ('Sherlock Holmes', 4567895215, 6457864359, 'Elementary' , 'sassybitch@whotmail.com', '221B Baker st', 1);
insert into Clients (name, phone1, description, isActive) values ('Mike Hunt', 4038648645, 'Kind of a cunt', 1);
insert into Clients (name, phone1, phone2, description, email, address, isActive) values ('James Hetfield', 5548761248, 46537518495, 'GIMME FUEL GIMME FIRE GIMME THAT WHICH I DESIRE OOOOH', 'james@metallica.com', 'Somewhere in colorado', 1);
insert into Clients (name, phone1, phone2, description, email, address, isActive) values ('Cameron Steinburg', 4035128991, 4035546265, 'Fly as hell', 'cameronsteinburg@live.ca', '105 Aspen Ridge Pl SW', 1);
insert into Clients (name, phone1, phone2, address, description, email, isActive) values ('Jane Jefferson', 123456789, 987654321, 'Gutter #276965', 'Smells like eggs', 'gamergurrllll@gmail.com', 1);
insert into Clients (name, phone1, description, email, isActive) values ('Billy Boyd', 842657952,'No Yarbles' , 'ben@jerrys.com', 1);
...
insert into Clients (name, phone1, phone2, description, email, isActive) values ('Artful Dodger', 47642865, 548672598, 'Welcome' , 'art@dodge.com', 1);
insert into Clients (name, phone1, phone2, email, address, isActive) values ('Gerard Way', 461544286, 645824654, 'g@way.com' ,'58264 Rose Hill Dr SE', 1);
insert into Clients (name, phone1, description, email, isActive) values ('Alex DeLarge', 4678154389, "Viddy Well, My Dear Brothers", 'iwascured@alright.com', 1);
insert into Clients (name, phone1, address, isActive) values ('Bill gates', 55555555, '1234 Super Rich Rd', 1);
insert into Clients (name, phone1, email, address, isActive) values ('Oliver Sykes', 64512437659, 'welsh@dropdead.com', '666 vegan st', 1);
insert into Clients (name, phone1, phone2, email, address, isActive) values ('Patrick Stump', 5642568759, 5556894258, 'fedora@fob.com' ,'88 Coopersonte Way NE', 1);
